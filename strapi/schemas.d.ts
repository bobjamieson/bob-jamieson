...
export interface ApiCasestudyCasestudy extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    snippet: TextAttribute;
    body: RichTextAttribute;
    slug: UIDAttribute<'api::casestudy.casestudy', 'title'>;
    image: MediaAttribute;
    techlist: RichTextAttribute;
    createdAt: DateTimeAttribute;
    updatedAt: DateTimeAttribute;
...
export interface ApiHeroHero extends SingleTypeSchema {
  info: {
    singularName: 'hero';
    pluralName: 'heroes';
    displayName: 'hero';
  ...
  attributes: {
    ...
    updatedAt: DateTimeAttribute;
    publishedAt: DateTimeAttribute;
    createdBy: RelationAttribute<'api::hero.hero', 'oneToOne', 'admin::user'> &
      PrivateAttribute;
    updatedBy: RelationAttribute<'api::hero.hero', 'oneToOne', 'admin::user'> &
      PrivateAttribute;
  };
}
